...
data:extend({
  ...
  },
  {
    ...
    results = {
      ...
      { type = "item", name = "angels-lubricated-milling-drum", amount = 1, ignored_by_productivity = 1 },
    },
  ...
  {
    type = "recipe",
    name = "angels-lubricated-milling-drum",
    ...
    results = {
      { type = "item", name = "angels-lubricated-milling-drum", amount = 1, ignored_by_stats = 1 },
    },
